"use strict";(()=>{var Ne=Object.create;var Mt=Object.defineProperty,Ue=Object.defineProperties,je=Object.getOwnPropertyDescriptor,Ge=Object.getOwnPropertyDescriptors,Ke=Object.getOwnPropertyNames,Gt=Object.getOwnPropertySymbols,qe=Object.getPrototypeOf,qt=Object.prototype.hasOwnProperty,_e=Object.prototype.propertyIsEnumerable;var O=Math.pow,Kt=(i,o,t)=>o in i?Mt(i,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[o]=t,T=(i,o)=>{for(var t in o||(o={}))qt.call(o,t)&&Kt(i,t,o[t]);if(Gt)for(var t of Gt(o))_e.call(o,t)&&Kt(i,t,o[t]);return i},k=(i,o)=>Ue(i,Ge(o));var Je=(i,o)=>()=>(o||i((o={exports:{}}).exports,o),o.exports);var Ze=(i,o,t,e)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of Ke(o))!qt.call(i,n)&&n!==t&&Mt(i,n,{get:()=>o[n],enumerable:!(e=je(o,n))||e.enumerable});return i};var Qe=(i,o,t)=>(t=i!=null?Ne(qe(i)):{},Ze(o||!i||!i.__esModule?Mt(t,"default",{value:i,enumerable:!0}):t,i));var I=(i,o,t)=>new Promise((e,n)=>{var a=l=>{try{c(t.next(l))}catch(s){n(s)}},r=l=>{try{c(t.throw(l))}catch(s){n(s)}},c=l=>l.done?e(l.value):Promise.resolve(l.value).then(a,r);c((t=t.apply(i,o)).next())});var Ie=Je((ki,ke)=>{"use strict";function un(i){for(var o=1/0,t=-1/0,e=0,n=i.length,a;e<n;e++)a=i[e],o>a&&(o=a),t<a&&(t=a);return{min:o,max:t}}function Ce(i,o){var t=Math.pow(2,o-1),e=i<0?i*t:i*(t-1);return Math.max(-t,Math.min(t-1,e))}function Ee(i,o,t){var e,n=i.length,a=Math.ceil(n/o),r,c,l,s,h,u,p=Me(t,a*2);for(e=0;e<a;e++)r=e*o,c=(e+1)*o>n?n:(e+1)*o,l=i.subarray(r,c),u=un(l),h=Ce(u.min,t),s=Ce(u.max,t),p[e*2]=h,p[e*2+1]=s;return p}function Me(i,o){return new(new Function(`return Int${i}Array`)())(o)}function pn(i,o){var t=i.length,e=1/t,n=i[0].length/2,a=0,r=0,c,l,s=Me(o,n*2);for(r=0;r<n;r++){for(c=0,l=0,a=0;a<t;a++)c+=e*i[a][r*2],l+=e*i[a][r*2+1];s[r*2]=c,s[r*2+1]=l}return[s]}function ft(i,o){return typeof i=="number"?i:o}ke.exports=function(i,o,t,e,n,a){if(o=ft(o,1e3),a=ft(a,16),t==null&&(t=!0),[8,16,32].indexOf(a)<0)throw new Error("Invalid number of bits specified for peaks.");var r=i.numberOfChannels,c=[],l,s,h,u;if(e=ft(e,0),n=ft(n,i.length),typeof i.subarray=="undefined")for(l=0;l<r;l++)h=i.getChannelData(l),u=h.subarray(e,n),c.push(Ee(u,o,a));else c.push(Ee(i.subarray(e,n),o,a));return t&&c.length>1&&(c=pn(c,a)),s=c[0].length/2,{length:s,data:c,bits:a}}});var tn={bgPrimary:"rgba(28, 28, 32, 0.95)",bgSecondary:"rgba(42, 42, 48, 0.98)",bgTertiary:"#35353d",bgHover:"rgba(255, 255, 255, 0.08)",bgActive:"rgba(255, 255, 255, 0.12)",textPrimary:"#f0f0f2",textSecondary:"#a8a8b0",textMuted:"#68687a",border:"rgba(255, 255, 255, 0.1)",borderHover:"rgba(255, 255, 255, 0.2)",accent:"#5b9fff",accentHover:"#7db3ff",shadow:"rgba(0, 0, 0, 0.4)"},en={bgPrimary:"rgba(250, 250, 252, 0.95)",bgSecondary:"rgba(255, 255, 255, 0.98)",bgTertiary:"#f0f0f5",bgHover:"rgba(0, 0, 0, 0.04)",bgActive:"rgba(0, 0, 0, 0.08)",textPrimary:"#1a1a24",textSecondary:"#5a5a6e",textMuted:"#9090a0",border:"rgba(0, 0, 0, 0.1)",borderHover:"rgba(0, 0, 0, 0.2)",accent:"#2563eb",accentHover:"#3b82f6",shadow:"rgba(0, 0, 0, 0.15)"},nn={dark:tn,light:en},d="sm-annotate";function on(i){return`
  ...
  `}var _=null;function kt(i="dark"){_||(_=document.createElement("style"),_.id=`${d}-theme-styles`,document.head.appendChild(_));let o=nn[i];_.textContent=`
    :root {
      ${on(o)}
    }
    ${an()}
  `}function F(i){i.classList.add(`${d}-btn`)}function _t(i){i.classList.add(`${d}-container`)}function Jt(i){i.classList.add(`${d}-player-controls`)}function Zt(i){i.classList.add(`${d}-color-picker`)}function Qt(i){i.classList.add(`${d}-slider`)}function te(i){i.classList.add(`${d}-fullscreen-btn`)}function J(){let i=document.createElement("div");return i.classList.add(`${d}-divider`),i}function K(){return d}function ee(i){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Toggle theme",F(o);let t=()=>{let e=i.theme==="dark";o.innerHTML=e?`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
`):Number(i)}function Mn(i){var r;let o=[],t=i.split(`
`),e=null,n=null,a=0;for(let c=0;c<t.length;c++){let l=t[c].trim();if(l===""||l.startsWith("#")||l==="GTOa (4)")continue;let s=l.match(/^(\S+)\s*:\s*(\S+)\s*\((\d+)\)\s*$/);if(s&&a===0){e={name:s[1],protocol:s[2],version:parseInt(s[3]),components:new Map},o.push(e);continue}if(l==="{"){a++;continue}if(l==="}"){a--,a===1&&(n=null),a===0&&(e=null);continue}if(e&&a>=1){if(a===1){let u=l.match(/^"([^"]+)"$/);if(u){n=u[1],e.components.has(n)||e.components.set(n,new Map);continue}if(!l.includes("=")&&!l.includes("[")){n=l,e.components.has(n)||e.components.set(n,new Map);continue}}let h=l.match(/^(\w+)(?:\[([^\]]*)\])?\s+(\w+)\s*=\s*(.+)$/);if(h&&n){let[,u,,p,g]=h,v=En(g,u);(r=e.components.get(n))==null||r.set(p,v)}}}return o}function We(i,o,t){return{x:(i/t+1)/2,y:(1-o)/2}}function kn(i,o,t){let e=i.get("points"),n=i.get("color"),a=i.get("width");if(!e||e.length<4)return null;let r=o/t,c=[];for(let u=0;u<e.length;u+=2){let p=We(e[u],e[u+1],r);c.push(p)}let l=n?St(n):"#000000",s=n&&n.length>=4?n[3]:1,h=2;if(typeof a=="number")h=a*t;else if(Array.isArray(a)&&a.length>0){let u=a[0];typeof u=="number"&&(h=u*t)}return h=Math.max(1,Math.min(h,50)),{type:"curve",points:c,strokeStyle:l,fillStyle:l,lineWidth:h,opacity:s}}function In(i,o,t){let e=i.get("position"),n=i.get("color"),a=i.get("text"),r=i.get("size");if(!e||e.length<2||!a)return null;let c=o/t,l=We(e[0],e[1],c),s=n?St(n):"#000000",h=n&&n.length>=4?n[3]:1,p=(r!=null?r:.01)*t,g=Math.max(1,(p-16)/.5);return{type:"text",x:l.x,y:l.y,text:a,strokeStyle:s,fillStyle:s,lineWidth:g,opacity:h}}function Bt(i,o={}){var u,p,g,v,x,y,m;let t={frames:[]},e=Mn(i),n=e.find(f=>f.protocol==="RVSession");if(n){let f=n.components.get("session");if(f){let b=f.get("name");typeof b=="string"&&(t.sessionName=b)}}let a=e.find(f=>f.protocol==="RVFileSource");if(a){let f=a.components.get("media");if(f){let w=f.get("movie");typeof w=="string"&&(t.mediaPath=w)}let b=a.components.get("request");if(b){let w=b.get("width"),E=b.get("height");typeof w=="number"&&typeof E=="number"&&(t.dimensions={width:w,height:E})}}let r=(g=(p=o.width)!=null?p:(u=t.dimensions)==null?void 0:u.width)!=null?g:1920,c=(y=(x=o.height)!=null?x:(v=t.dimensions)==null?void 0:v.height)!=null?y:1080,l=(m=o.fps)!=null?m:25;t.fps=l;let s=e.filter(f=>f.protocol==="RVPaint");if(s.length===0)return t;let h=new Map;for(let f of s)for(let[b,w]of f.components){let E=b.match(/^pen:\d+:(\d+):/i);if(E){let S=parseInt(E[1]),P=kn(w,r,c);P&&(h.has(S)||h.set(S,[]),h.get(S).push(P));continue}let C=b.match(/^text:\d+:(\d+):/i);if(C){let S=parseInt(C[1]),P=In(w,r,c);P&&(h.has(S)||h.set(S,[]),h.get(S).push(P))}}for(let[f,b]of h)t.frames.push({frame:f,fps:l,version:1,shapes:b});return t.frames.sort((f,b)=>f.frame-b.frame),t}function Ct(t){return I(this,arguments,function*(i,o={}){let e=yield i.text();return Bt(e,o)})}B.prototype.initUI=Te;B.prototype.initCanvas=Se;B.prototype.addFrameSquareOverlay=De;B.prototype.addVideoOverlay=Be;B.prototype.addProgressBarOverlay=Oe;new EventSource("/esbuild").addEventListener("change",()=>location.reload());var A=document.querySelector("video");function Xe(){return I(this,null,function*(){let i=yield fetch(A.currentSrc).then(y=>y.blob()),o=new Promise(y=>{setTimeout(()=>{y(!0)},250),A.addEventListener("loadeddata",()=>{y(!0)},{once:!0})}),t=yield fetch("./frame_29.png").then(y=>I(this,null,function*(){let m=yield y.blob(),f=new Blob([m],{type:"image/png"}),b=new Image,w=new Promise(E=>{b.addEventListener("load",()=>{E(!0)},{once:!0})});return b.src=window.URL.createObjectURL(f),yield w,b}));A.paused||A.pause();let e=new Blob([i],{type:"video/mp4"}),n=new B(A);yield n.setVideoBlob(e,30),yield o,yield n.addReferenceVideoByURL("./mov_bbb_g.mp4"),requestAnimationFrame(()=>{n.setCanvasSize()}),n.enableVideoFrameBuffer(),console.log({tool:n}),n.addShapesToFrame(29,[{type:"image",image:t,x:0,y:0,width:1,height:1,strokeStyle:"red",lineWidth:2,fillStyle:"red"}]),A.paused||A.pause(),setInterval(()=>{n.destroy(),n.init(A)},1e8),setInterval(()=>{console.log(n.saveAllFrames())},1e5);let a=document.getElementById("file"),r=document.getElementById("download"),c=document.getElementById("sample"),l=document.getElementById("video"),s=document.getElementById("ref-video");l.addEventListener("change",y=>I(this,null,function*(){if(!l.files||l.files.length===0)return;let m=prompt("Enter FPS","30");if(!m)return;let f=l.files[0],b=new Blob([f],{type:f.type});yield n.setVideoBlob(b,parseInt(m,10))})),s.addEventListener("change",y=>I(this,null,function*(){if(!s.files||s.files.length===0)return;let m=prompt("Enter FPS","30");if(!m)return;let f=s.files[0],b=new Blob([f],{type:f.type}),w=window.URL.createObjectURL(b);yield n.addReferenceVideoByURL(w,parseInt(m,10),f.type)})),c.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault(),fetch("./annotations-sample.json").then(m=>m.json()).then(m=>{n.loadAllFrames(m),n.redrawFullCanvas()})}),a.addEventListener("change",y=>{if(!a.files||a.files.length===0)return;let m=a.files[0],f=new FileReader;f.onload=b=>{if(!b.target)return;let w=b.target.result,E=JSON.parse(w);confirm("Append to existing annotations?")?n.appendFrames(E):n.loadAllFrames(E),n.redrawFullCanvas()},f.readAsText(m)}),r.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault();let m=n.saveAllFrames(),f=document.createElement("a");f.href=URL.createObjectURL(new Blob([JSON.stringify(m)],{type:"application/json"}));let b=new Date().toISOString().replace(/:/g,"-");f.download=`annotations-${b}.json`,f.click()});let h=document.getElementById("rv-file"),u=document.getElementById("download-rv");h.addEventListener("change",y=>I(this,null,function*(){if(!h.files||h.files.length===0)return;let m=h.files[0];try{let f=A.videoWidth||n.canvasWidth||1920,b=A.videoHeight||n.canvasHeight||1080,w=yield Ct(m,{width:f,height:b,fps:n.fps});confirm("Append to existing annotations?")?n.appendFrames(w.frames):n.loadAllFrames(w.frames),n.updateActiveTimeFrame(),n.redrawFullCanvas();let C=w.frames.map(S=>S.frame);console.log(`Loaded ${w.frames.length} annotated frames:`,C),w.mediaPath&&console.log("OpenRV media path:",w.mediaPath)}catch(f){console.error("Failed to parse OpenRV file:",f),alert("Failed to parse OpenRV file. Check console for details.")}})),u.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault();let m=n.saveAllFrames();if(m.length===0){alert("No annotations to export.");return}let f=new Date().toISOString().replace(/:/g,"-");Tt(m,{mediaPath:A.currentSrc||"video.mp4",width:n.canvasWidth||1920,height:n.canvasHeight||1080,sessionName:`sm-annotate-${f}`},`annotations-${f}.rv`)});let p=document.querySelectorAll(".layout-btn"),g=document.getElementById("layout-label"),v={horizontal:"Horizontal (default)",vertical:"Vertical Sidebar",minimal:"Minimal / Floating","bottom-dock":"Bottom Dock"};p.forEach(y=>{y.addEventListener("click",m=>{let f=m.currentTarget,b=f.dataset.layout;p.forEach(w=>w.classList.remove("active")),f.classList.add("active"),g&&(g.textContent=v[b]),n.setLayout(b),requestAnimationFrame(()=>{n.setCanvasSize()})})});let x;window.addEventListener("resize",()=>{x&&clearTimeout(x),x=window.setTimeout(()=>{n.setCanvasSize()},100)})})}A.readyState===0?A.addEventListener("loadedmetadata",()=>{requestAnimationFrame(()=>{Xe()})},{once:!0}):Xe();})();
