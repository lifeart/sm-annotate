...
`),e=null,n=null,a=0;for(let c=0;c<t.length;c++){let l=t[c].trim();if(l===""||l.startsWith("#")||l==="GTOa (4)")continue;let s=l.match(/^(\S+)\s*:\s*(\S+)\s*\((\d+)\)\s*$/);if(s&&a===0){e={name:s[1],protocol:s[2],version:parseInt(s[3]),components:new Map},o.push(e);continue}if(l==="{"){a++;continue}if(l==="}"){a--,a===1&&(n=null),a===0&&(e=null);continue}if(e&&a>=1){if(a===1){let u=l.match(/^"([^"]+)"$/);if(u){n=u[1],e.components.has(n)||e.components.set(n,new Map);continue}if(!l.includes("=")&&!l.includes("[")){n=l,e.components.has(n)||e.components.set(n,new Map);continue}}let h=l.match(/^(\w+)(?:\[([^\]]*)\])?\s+(\w+)\s*=\s*(.+)$/);if(h&&n){let[,u,,p,g]=h,v=En(g,u);(r=e.components.get(n))==null||r.set(p,v)}}}return o}function We(i,o,t){return{x:(i/t+1)/2,y:(1-o)/2}}function kn(i,o,t){let e=i.get("points"),n=i.get("color"),a=i.get("width");if(!e||e.length<4)return null;let r=o/t,c=[];for(let u=0;u<e.length;u+=2){let p=We(e[u],e[u+1],r);c.push(p)}let l=n?St(n):"#000000",s=n&&n.length>=4?n[3]:1,h=2;if(typeof a=="number")h=a*t;else if(Array.isArray(a)&&a.length>0){let u=a[0];typeof u=="number"&&(h=u*t)}return h=Math.max(1,Math.min(h,50)),{type:"curve",points:c,strokeStyle:l,fillStyle:l,lineWidth:h,opacity:s}}function In(i,o,t){let e=i.get("position"),n=i.get("color"),a=i.get("text"),r=i.get("size");if(!e||e.length<2||!a)return null;let c=o/t,l=We(e[0],e[1],c),s=n?St(n):"#000000",h=n&&n.length>=4?n[3]:1,p=(r!=null?r:.01)*t,g=Math.max(1,(p-16)/.5);return{type:"text",x:l.x,y:l.y,text:a,strokeStyle:s,fillStyle:s,lineWidth:g,opacity:h}}function Bt(i,o={}){var u,p,g,v,x,y,f;let t={frames:[]},e=Mn(i),n=e.find(m=>m.protocol==="RVSession");if(n){let m=n.components.get("session");if(m){let b=m.get("name");typeof b=="string"&&(t.sessionName=b)}}let a=e.find(m=>m.protocol==="RVFileSource");if(a){let m=a.components.get("media");if(m){let w=m.get("movie");typeof w=="string"&&(t.mediaPath=w)}let b=a.components.get("request");if(b){let w=b.get("width"),E=b.get("height");typeof w=="number"&&typeof E=="number"&&(t.dimensions={width:w,height:E})}}let r=(g=(p=o.width)!=null?p:(u=t.dimensions)==null?void 0:u.width)!=null?g:1920,c=(y=(x=o.height)!=null?x:(v=t.dimensions)==null?void 0:v.height)!=null?y:1080,l=(f=o.fps)!=null?f:25;t.fps=l;let s=e.find(m=>m.protocol==="RVPaint");if(!s)return t;let h=new Map;for(let[m,b]of s.components){let w=m.match(/^pen:\d+:(\d+):/i);if(w){let S=parseInt(w[1]),M=kn(b,r,c);M&&(h.has(S)||h.set(S,[]),h.get(S).push(M));continue}let E=m.match(/^text:\d+:(\d+):/i);if(E){let S=parseInt(E[1]),M=In(b,r,c);M&&(h.has(S)||h.set(S,[]),h.get(S).push(M))}}for(let[m,b]of h)t.frames.push({frame:m,fps:l,version:1,shapes:b});return t.frames.sort((m,b)=>m.frame-b.frame),t}function Ct(t){return I(this,arguments,function*(i,o={}){let e=yield i.text();return Bt(e,o)})}B.prototype.initUI=Te;B.prototype.initCanvas=Se;B.prototype.addFrameSquareOverlay=De;B.prototype.addVideoOverlay=Be;B.prototype.addProgressBarOverlay=Oe;new EventSource("/esbuild").addEventListener("change",()=>location.reload());var H=document.querySelector("video");function Xe(){return I(this,null,function*(){let i=yield fetch(H.currentSrc).then(y=>y.blob()),o=new Promise(y=>{setTimeout(()=>{y(!0)},250),H.addEventListener("loadeddata",()=>{y(!0)},{once:!0})}),t=yield fetch("./frame_29.png").then(y=>I(this,null,function*(){let f=yield y.blob(),m=new Blob([f],{type:"image/png"}),b=new Image,w=new Promise(E=>{b.addEventListener("load",()=>{E(!0)},{once:!0})});return b.src=window.URL.createObjectURL(m),yield w,b}));H.paused||H.pause();let e=new Blob([i],{type:"video/mp4"}),n=new B(H);yield n.setVideoBlob(e,30),yield o,yield n.addReferenceVideoByURL("./mov_bbb_g.mp4"),requestAnimationFrame(()=>{n.setCanvasSize()}),n.enableVideoFrameBuffer(),console.log({tool:n}),n.addShapesToFrame(29,[{type:"image",image:t,x:0,y:0,width:1,height:1,strokeStyle:"red",lineWidth:2,fillStyle:"red"}]),H.paused||H.pause(),setInterval(()=>{n.destroy(),n.init(H)},1e8),setInterval(()=>{console.log(n.saveAllFrames())},1e5);let a=document.getElementById("file"),r=document.getElementById("download"),c=document.getElementById("sample"),l=document.getElementById("video"),s=document.getElementById("ref-video");l.addEventListener("change",y=>I(this,null,function*(){if(!l.files||l.files.length===0)return;let f=prompt("Enter FPS","30");if(!f)return;let m=l.files[0],b=new Blob([m],{type:m.type});yield n.setVideoBlob(b,parseInt(f,10))})),s.addEventListener("change",y=>I(this,null,function*(){if(!s.files||s.files.length===0)return;let f=prompt("Enter FPS","30");if(!f)return;let m=s.files[0],b=new Blob([m],{type:m.type}),w=window.URL.createObjectURL(b);yield n.addReferenceVideoByURL(w,parseInt(f,10),m.type)})),c.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault(),fetch("./annotations-sample.json").then(f=>f.json()).then(f=>{n.loadAllFrames(f),n.redrawFullCanvas()})}),a.addEventListener("change",y=>{if(!a.files||a.files.length===0)return;let f=a.files[0],m=new FileReader;m.onload=b=>{if(!b.target)return;let w=b.target.result,E=JSON.parse(w);confirm("Append to existing annotations?")?n.appendFrames(E):n.loadAllFrames(E),n.redrawFullCanvas()},m.readAsText(f)}),r.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault();let f=n.saveAllFrames(),m=document.createElement("a");m.href=URL.createObjectURL(new Blob([JSON.stringify(f)],{type:"application/json"}));let b=new Date().toISOString().replace(/:/g,"-");m.download=`annotations-${b}.json`,m.click()});let h=document.getElementById("rv-file"),u=document.getElementById("download-rv");h.addEventListener("change",y=>I(this,null,function*(){if(!h.files||h.files.length===0)return;let f=h.files[0];try{let m=yield Ct(f,{width:n.canvasWidth||1920,height:n.canvasHeight||1080,fps:n.fps});confirm("Append to existing annotations?")?n.appendFrames(m.frames):n.loadAllFrames(m.frames),n.redrawFullCanvas(),m.mediaPath&&console.log("OpenRV media path:",m.mediaPath),m.sessionName&&console.log("OpenRV session:",m.sessionName)}catch(m){console.error("Failed to parse OpenRV file:",m),alert("Failed to parse OpenRV file. Check console for details.")}})),u.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault();let f=n.saveAllFrames();if(f.length===0){alert("No annotations to export.");return}let m=new Date().toISOString().replace(/:/g,"-");Tt(f,{mediaPath:H.currentSrc||"video.mp4",width:n.canvasWidth||1920,height:n.canvasHeight||1080,sessionName:`sm-annotate-${m}`},`annotations-${m}.rv`)});let p=document.querySelectorAll(".layout-btn"),g=document.getElementById("layout-label"),v={horizontal:"Horizontal (default)",vertical:"Vertical Sidebar",minimal:"Minimal / Floating","bottom-dock":"Bottom Dock"};p.forEach(y=>{y.addEventListener("click",f=>{let m=f.currentTarget,b=m.dataset.layout;p.forEach(w=>w.classList.remove("active")),m.classList.add("active"),g&&(g.textContent=v[b]),n.setLayout(b),requestAnimationFrame(()=>{n.setCanvasSize()})})});let x;window.addEventListener("resize",()=>{x&&clearTimeout(x),x=window.setTimeout(()=>{n.setCanvasSize()},100)})})}H.readyState===0?H.addEventListener("loadedmetadata",()=>{requestAnimationFrame(()=>{Xe()})},{once:!0}):Xe();})();
