var Be=Object.create;var bt=Object.defineProperty,Oe=Object.defineProperties,ze=Object.getOwnPropertyDescriptor,Ve=Object.getOwnPropertyDescriptors,We=Object.getOwnPropertyNames,Wt=Object.getOwnPropertySymbols,Xe=Object.getPrototypeOf,Yt=Object.prototype.hasOwnProperty,Ye=Object.prototype.propertyIsEnumerable;var D=Math.pow,Xt=(i,o,t)=>o in i?bt(i,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[o]=t,T=(i,o)=>{for(var t in o||(o={}))Yt.call(o,t)&&Xt(i,t,o[t]);if(Wt)for(var t of Wt(o))Ye.call(o,t)&&Xt(i,t,o[t]);return i},M=(i,o)=>Oe(i,Ve(o));var Ne=(i,o)=>()=>(o||i((o={exports:{}}).exports,o),o.exports);var Ge=(i,o,t,e)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of We(o))!Yt.call(i,n)&&n!==t&&bt(i,n,{get:()=>o[n],enumerable:!(e=ze(o,n))||e.enumerable});return i};var Ue=(i,o,t)=>(t=i!=null?Be(Xe(i)):{},Ge(o||!i||!i.__esModule?bt(t,"default",{value:i,enumerable:!0}):t,i));var E=(i,o,t)=>new Promise((e,n)=>{var a=s=>{try{h(t.next(s))}catch(l){n(l)}},r=s=>{try{h(t.throw(s))}catch(l){n(l)}},h=s=>s.done?e(s.value):Promise.resolve(s.value).then(a,r);h((t=t.apply(i,o)).next())});var we=Ne((Ti,Te)=>{"use strict";function an(i){for(var o=1/0,t=-1/0,e=0,n=i.length,a;e<n;e++)a=i[e],o>a&&(o=a),t<a&&(t=a);return{min:o,max:t}}function ye(i,o){var t=Math.pow(2,o-1),e=i<0?i*t:i*(t-1);return Math.max(-t,Math.min(t-1,e))}function xe(i,o,t){var e,n=i.length,a=Math.ceil(n/o),r,h,s,l,c,u,p=be(t,a*2);for(e=0;e<a;e++)r=e*o,h=(e+1)*o>n?n:(e+1)*o,s=i.subarray(r,h),u=an(s),c=ye(u.min,t),l=ye(u.max,t),p[e*2]=c,p[e*2+1]=l;return p}function be(i,o){return new(new Function(`return Int${i}Array`)())(o)}function rn(i,o){var t=i.length,e=1/t,n=i[0].length/2,a=0,r=0,h,s,l=be(o,n*2);for(r=0;r<n;r++){for(h=0,s=0,a=0;a<t;a++)h+=e*i[a][r*2],s+=e*i[a][r*2+1];l[r*2]=h,l[r*2+1]=s}return[l]}function mt(i,o){return typeof i=="number"?i:o}Te.exports=function(i,o,t,e,n,a){if(o=mt(o,1e3),a=mt(a,16),t==null&&(t=!0),[8,16,32].indexOf(a)<0)throw new Error("Invalid number of bits specified for peaks.");var r=i.numberOfChannels,h=[],s,l,c,u;if(e=mt(e,0),n=mt(n,i.length),typeof i.subarray=="undefined")for(s=0;s<r;s++)c=i.getChannelData(s),u=c.subarray(e,n),h.push(xe(u,o,a));else h.push(xe(i.subarray(e,n),o,a));return t&&h.length>1&&(h=rn(h,a)),l=h[0].length/2,{length:l,data:h,bits:a}}});var je={bgPrimary:"rgba(28, 28, 32, 0.95)",bgSecondary:"rgba(42, 42, 48, 0.98)",bgTertiary:"#35353d",bgHover:"rgba(255, 255, 255, 0.08)",bgActive:"rgba(255, 255, 255, 0.12)",textPrimary:"#f0f0f2",textSecondary:"#a8a8b0",textMuted:"#68687a",border:"rgba(255, 255, 255, 0.1)",borderHover:"rgba(255, 255, 255, 0.2)",accent:"#5b9fff",accentHover:"#7db3ff",shadow:"rgba(0, 0, 0, 0.4)"},Ke={bgPrimary:"rgba(250, 250, 252, 0.95)",bgSecondary:"rgba(255, 255, 255, 0.98)",bgTertiary:"#f0f0f5",bgHover:"rgba(0, 0, 0, 0.04)",bgActive:"rgba(0, 0, 0, 0.08)",textPrimary:"#1a1a24",textSecondary:"#5a5a6e",textMuted:"#9090a0",border:"rgba(0, 0, 0, 0.1)",borderHover:"rgba(0, 0, 0, 0.2)",accent:"#2563eb",accentHover:"#3b82f6",shadow:"rgba(0, 0, 0, 0.15)"},qe={dark:je,light:Ke},d="sm-annotate";function _e(i){return`
  ...
  `}var K=null;function Tt(i="dark"){K||(K=document.createElement("style"),K.id=`${d}-theme-styles`,document.head.appendChild(K));let o=qe[i];K.textContent=`
    :root {
      ${_e(o)}
    }
    ${Je()}
  `}function F(i){i.classList.add(`${d}-btn`)}function Nt(i){i.classList.add(`${d}-container`)}function Gt(i){i.classList.add(`${d}-player-controls`)}function Ut(i){i.classList.add(`${d}-color-picker`)}function jt(i){i.classList.add(`${d}-slider`)}function Kt(i){i.classList.add(`${d}-fullscreen-btn`)}function q(){let i=document.createElement("div");return i.classList.add(`${d}-divider`),i}function _(){return d}function qt(i){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Toggle theme",F(o);let t=()=>{let e=i.theme==="dark";o.innerHTML=e?`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        </svg>`};return t(),i.addEvent(o,"click",()=>{i.setTheme(i.theme==="dark"?"light":"dark"),t()}),o}function _t(i,o){let t=document.createElement("button");t.type="button",F(t),t.style.float="right",t.dataset.tooltip="Download frame",t.dataset.tooltipPosition="bottom",t.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-image"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect><circle cx="9" cy="9" r="2"></circle><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"></path></svg>',o.addEvent(t,"click",()=>{let e=o.frameToDataUrl();if(!e)return;let n=document.createElement("a");n.download=`frame_${String(o.activeTimeFrame).padStart(3,"0")}.png`,n.href=e,n.click()}),o.buttons.push(t),o.playerControlsContainer.appendChild(t)}var Jt='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-volume-x"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><line x1="22" x2="16" y1="9" y2="15"></line><line x1="16" x2="22" y1="9" y2="15"></line></svg>',Zt='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-volume-2"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M15.54 8.46a5 5 0 0 1 0 7.07"></path><path d="M19.07 4.93a10 10 0 0 1 0 14.14"></path></svg>';function Qt(i,o){let t=document.createElement("button");t.type="button",F(t),t.dataset.tooltip="Mute/Unmute",t.dataset.tooltipPosition="bottom",i.muted||i.volume===0?t.innerHTML=Jt:t.innerHTML=Zt,o.addEvent(i,"volumechange",()=>{i.muted||i.volume===0?t.innerHTML=Jt:t.innerHTML=Zt}),o.addEvent(t,"click",()=>{if(i.muted){i.muted=!1;return}i.volume===0?i.volume=1:i.volume=0}),o.buttons.push(t),o.playerControlsContainer.appendChild(t)}var O=[{value:0,label:"off"},{value:.25,label:"25%"},{value:.5,label:"50%"},{value:.7,label:"70%"},{value:1,label:"100%"}];function te(i,o=!1){let t=o?'<circle cx="18" cy="6" r="4" fill="currentColor" opacity="0.7"/>':"";return`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <style>
      .label {
    ...
    ${t}
  </svg>`}function wt(i){let o=O.findIndex(t=>t.value===i);return o===-1?4:o}function ee(i){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Opacity";let t=wt(i.overlayOpacity),e=()=>{var h;let a=i.currentTool==="move"?i.pluginForTool("move"):null,r=a==null?void 0:a.getSelectedShape();if(r){let s=(h=r.opacity)!=null?h:1,l=wt(s);o.innerHTML=te(O[l],!0),o.dataset.tooltip="Shape opacity"}else o.innerHTML=te(O[t],!1),o.dataset.tooltip="Overlay opacity"};e(),F(o),i.addEvent(o,"click",()=>{var h;let a=i.currentTool==="move"?i.pluginForTool("move"):null,r=a==null?void 0:a.getSelectedShape();if(r&&a){let s=(h=r.opacity)!=null?h:1,l=wt(s);l=(l+1)%O.length;let c=O[l].value;a.setSelectedShapeOpacity(c)}else t=(t+1)%O.length,i.overlayOpacity=O[t].value,i.redrawFullCanvas();e()});let n=i.redrawFullCanvas.bind(i);return i.redrawFullCanvas=()=>{n(),e()},i.buttons.push(o),i.uiContainer.appendChild(o),o}var ne='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>',Ze='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pause"><rect width="4" height="16" x="6" y="4"></rect><rect width="4" height="16" x="14" y="4"></rect></svg>';function oe(i,o){let t=document.createElement("button");t.type="button",t.innerHTML=ne,F(t),t.dataset.tooltip="Play/Pause",t.dataset.tooltipPosition="bottom",o.addEvent(i,"play",()=>{t.innerHTML=Ze}),o.addEvent(i,"pause",()=>{t.innerHTML=ne}),o.addEvent(t,"click",()=>{o.withRefVideo(e=>{e.paused&&e.play().then(()=>{o.showButton("compare")})}),i.paused?i.play().then(()=>{o.redrawFullCanvas()}):(i.pause(),o.raf(()=>{o.redrawFullCanvas()}))}),o.buttons.push(t),o.playerControlsContainer.appendChild(t)}function ie(i){return`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-superscript">
        <style>
            .small {
                font-family: auto;
