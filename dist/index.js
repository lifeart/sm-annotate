...
`),e=null,n=null,a=0;for(let h=0;h<t.length;h++){let l=t[h].trim();if(l===""||l.startsWith("#")||l==="GTOa (4)")continue;let s=l.match(/^(\S+)\s*:\s*(\S+)\s*\((\d+)\)\s*$/);if(s&&a===0){e={name:s[1],protocol:s[2],version:parseInt(s[3]),components:new Map},i.push(e);continue}if(l==="{"){a++;continue}if(l==="}"){a--,a===1&&(n=null),a===0&&(e=null);continue}if(e&&a>=1){if(a===1){let u=l.match(/^"([^"]+)"$/);if(u){n=u[1],e.components.has(n)||e.components.set(n,new Map);continue}if(!l.includes("=")&&!l.includes("[")){n=l,e.components.has(n)||e.components.set(n,new Map);continue}}let c=l.match(/^(\w+)(?:\[([^\]]*)\])?\s+(\w+)\s*=\s*(.+)$/);if(c&&n){let[,u,,p,m]=c,f=Sn(m,u);(r=e.components.get(n))==null||r.set(p,f)}}}return i}function ze(o,i,t){return{x:(o+1)/2,y:(1-i)/2}}function kn(o,i,t){let e=o.get("points"),n=o.get("color"),a=o.get("width");if(!e||e.length<4)return null;let r=i/t,h=[];for(let u=0;u<e.length;u+=2){let p=ze(e[u],e[u+1],r);h.push(p)}let l=n?wt(n):"#000000",s=n&&n.length>=4?n[3]:1,c=2;if(typeof a=="number")c=a*t;else if(Array.isArray(a)&&a.length>0){let u=a[0];typeof u=="number"&&(c=u*t)}return c=Math.max(1,Math.min(c,50)),{type:"curve",points:h,strokeStyle:l,fillStyle:l,lineWidth:c,opacity:s}}function Mn(o,i,t){let e=o.get("position"),n=o.get("color"),a=o.get("text"),r=o.get("size");if(!e||e.length<2||!a)return null;let h=i/t,l=ze(e[0],e[1],h),s=n?wt(n):"#000000",c=n&&n.length>=4?n[3]:1,p=(r!=null?r:.01)*t,m=Math.max(1,(p-16)/.5);return{type:"text",x:l.x,y:l.y,text:a,strokeStyle:s,fillStyle:s,lineWidth:m,opacity:c}}function Ht(o,i={}){var u,p,m,f,y,x,v;let t={frames:[]},e=Cn(o),n=e.find(g=>g.protocol==="RVSession");if(n){let g=n.components.get("session");if(g){let b=g.get("name");typeof b=="string"&&(t.sessionName=b)}}let a=e.find(g=>g.protocol==="RVFileSource");if(a){let g=a.components.get("media");if(g){let w=g.get("movie");typeof w=="string"&&(t.mediaPath=w)}let b=a.components.get("proxy");if(b){let w=b.get("size");w&&w.length>=2&&(t.dimensions={width:w[0],height:w[1]})}if(!t.dimensions){let w=a.components.get("request");if(w){let E=w.get("width"),S=w.get("height");typeof E=="number"&&typeof S=="number"&&(t.dimensions={width:E,height:S})}}}if(!t.dimensions){let g=e.find(b=>b.protocol==="RVStack");if(g){let b=g.components.get("output");if(b){let w=b.get("size");w&&w.length>=2&&(t.dimensions={width:w[0],height:w[1]})}}}if(!t.dimensions){let g=e.find(b=>b.protocol==="RVSequence");if(g){let b=g.components.get("output");if(b){let w=b.get("size");w&&w.length>=2&&(t.dimensions={width:w[0],height:w[1]})}}}let r=(m=(p=(u=t.dimensions)==null?void 0:u.width)!=null?p:i.width)!=null?m:1920,h=(x=(y=(f=t.dimensions)==null?void 0:f.height)!=null?y:i.height)!=null?x:1080,l=(v=i.fps)!=null?v:25;t.fps=l;let s=e.filter(g=>g.protocol==="RVPaint");if(s.length===0)return t;let c=new Map;for(let g of s)for(let[b,w]of g.components){let E=b.match(/^pen:\d+:(\d+):/i);if(E){let C=parseInt(E[1]),I=kn(w,r,h);I&&(c.has(C)||c.set(C,[]),c.get(C).push(I));continue}let S=b.match(/^text:\d+:(\d+):/i);if(S){let C=parseInt(S[1]),I=Mn(w,r,h);I&&(c.has(C)||c.set(C,[]),c.get(C).push(I))}}for(let[g,b]of c)t.frames.push({frame:g,fps:l,version:1,shapes:b});return t.frames.sort((g,b)=>g.frame-b.frame),t}function Ve(t){return P(this,arguments,function*(o,i={}){let e=yield o.text();return Ht(e,i)})}B.prototype.initUI=xe;B.prototype.initCanvas=be;B.prototype.addFrameSquareOverlay=Le;B.prototype.addVideoOverlay=He;B.prototype.addProgressBarOverlay=$e;export{B as SmAnnotate,W as defaultConfig,Oe as downloadAsOpenRV,Lt as exportToOpenRV,Rt as hexToRGBA,Ht as parseOpenRV,Ve as parseOpenRVFile,wt as rgbaToHex};
