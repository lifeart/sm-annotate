var Xe=Object.create;var St=Object.defineProperty,Ye=Object.defineProperties,Ne=Object.getOwnPropertyDescriptor,Ue=Object.getOwnPropertyDescriptors,Ge=Object.getOwnPropertyNames,Nt=Object.getOwnPropertySymbols,je=Object.getPrototypeOf,Gt=Object.prototype.hasOwnProperty,Ke=Object.prototype.propertyIsEnumerable;var D=Math.pow,Ut=(i,o,t)=>o in i?St(i,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[o]=t,T=(i,o)=>{for(var t in o||(o={}))Gt.call(o,t)&&Ut(i,t,o[t]);if(Nt)for(var t of Nt(o))Ke.call(o,t)&&Ut(i,t,o[t]);return i},E=(i,o)=>Ye(i,Ue(o));var qe=(i,o)=>()=>(o||i((o={exports:{}}).exports,o),o.exports);var _e=(i,o,t,e)=>{if(o&&typeof o=="object"||typeof o=="function")for(let n of Ge(o))!Gt.call(i,n)&&n!==t&&St(i,n,{get:()=>o[n],enumerable:!(e=Ne(o,n))||e.enumerable});return i};var Je=(i,o,t)=>(t=i!=null?Xe(je(i)):{},_e(o||!i||!i.__esModule?St(t,"default",{value:i,enumerable:!0}):t,i));var P=(i,o,t)=>new Promise((e,n)=>{var a=l=>{try{h(t.next(l))}catch(s){n(s)}},r=l=>{try{h(t.throw(l))}catch(s){n(s)}},h=l=>l.done?e(l.value):Promise.resolve(l.value).then(a,r);h((t=t.apply(i,o)).next())});var ke=qe((Pi,Ce)=>{"use strict";function mn(i){for(var o=1/0,t=-1/0,e=0,n=i.length,a;e<n;e++)a=i[e],o>a&&(o=a),t<a&&(t=a);return{min:o,max:t}}function we(i,o){var t=Math.pow(2,o-1),e=i<0?i*t:i*(t-1);return Math.max(-t,Math.min(t-1,e))}function Te(i,o,t){var e,n=i.length,a=Math.ceil(n/o),r,h,l,s,c,u,p=Se(t,a*2);for(e=0;e<a;e++)r=e*o,h=(e+1)*o>n?n:(e+1)*o,l=i.subarray(r,h),u=mn(l),c=we(u.min,t),s=we(u.max,t),p[e*2]=c,p[e*2+1]=s;return p}function Se(i,o){return new(new Function(`return Int${i}Array`)())(o)}function fn(i,o){var t=i.length,e=1/t,n=i[0].length/2,a=0,r=0,h,l,s=Se(o,n*2);for(r=0;r<n;r++){for(h=0,l=0,a=0;a<t;a++)h+=e*i[a][r*2],l+=e*i[a][r*2+1];s[r*2]=h,s[r*2+1]=l}return[s]}function mt(i,o){return typeof i=="number"?i:o}Ce.exports=function(i,o,t,e,n,a){if(o=mt(o,1e3),a=mt(a,16),t==null&&(t=!0),[8,16,32].indexOf(a)<0)throw new Error("Invalid number of bits specified for peaks.");var r=i.numberOfChannels,h=[],l,s,c,u;if(e=mt(e,0),n=mt(n,i.length),typeof i.subarray=="undefined")for(l=0;l<r;l++)c=i.getChannelData(l),u=c.subarray(e,n),h.push(Te(u,o,a));else h.push(Te(i.subarray(e,n),o,a));return t&&h.length>1&&(h=fn(h,a)),s=h[0].length/2,{length:s,data:h,bits:a}}});var Ze={bgPrimary:"rgba(28, 28, 32, 0.95)",bgSecondary:"rgba(42, 42, 48, 0.98)",bgTertiary:"#35353d",bgHover:"rgba(255, 255, 255, 0.08)",bgActive:"rgba(255, 255, 255, 0.12)",textPrimary:"#f0f0f2",textSecondary:"#a8a8b0",textMuted:"#68687a",border:"rgba(255, 255, 255, 0.1)",borderHover:"rgba(255, 255, 255, 0.2)",accent:"#5b9fff",accentHover:"#7db3ff",shadow:"rgba(0, 0, 0, 0.4)"},Qe={bgPrimary:"rgba(250, 250, 252, 0.95)",bgSecondary:"rgba(255, 255, 255, 0.98)",bgTertiary:"#f0f0f5",bgHover:"rgba(0, 0, 0, 0.04)",bgActive:"rgba(0, 0, 0, 0.08)",textPrimary:"#1a1a24",textSecondary:"#5a5a6e",textMuted:"#9090a0",border:"rgba(0, 0, 0, 0.1)",borderHover:"rgba(0, 0, 0, 0.2)",accent:"#2563eb",accentHover:"#3b82f6",shadow:"rgba(0, 0, 0, 0.15)"},tn={dark:Ze,light:Qe},d="sm-annotate";function en(i){return`
  ...
  `}var q=null;function Ct(i="dark"){q||(q=document.createElement("style"),q.id=`${d}-theme-styles`,document.head.appendChild(q));let o=tn[i];q.textContent=`
    :root {
      ${en(o)}
    }
    ${nn()}
  `}function F(i){i.classList.add(`${d}-btn`)}function jt(i){i.classList.add(`${d}-container`)}function Kt(i){i.classList.add(`${d}-player-controls`)}function qt(i){i.classList.add(`${d}-color-picker`)}function _t(i){i.classList.add(`${d}-slider`)}function Jt(i){i.classList.add(`${d}-fullscreen-btn`)}function _(){let i=document.createElement("div");return i.classList.add(`${d}-divider`),i}function j(){return d}function Zt(i){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Toggle theme",F(o);let t=()=>{let e=i.theme==="dark";o.innerHTML=e?`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    ${t}
  </svg>`}function kt(i){let o=O.findIndex(t=>t.value===i);return o===-1?4:o}function ie(i){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Opacity";let t=kt(i.overlayOpacity),e=()=>{var h;let a=i.currentTool==="move"?i.pluginForTool("move"):null,r=a==null?void 0:a.getSelectedShape();if(r){let l=(h=r.opacity)!=null?h:1,s=kt(l);o.innerHTML=oe(O[s],!0),o.dataset.tooltip="Shape opacity"}else o.innerHTML=oe(O[t],!1),o.dataset.tooltip="Overlay opacity"};e(),F(o),i.addEvent(o,"click",()=>{var h;let a=i.currentTool==="move"?i.pluginForTool("move"):null,r=a==null?void 0:a.getSelectedShape();if(r&&a){let l=(h=r.opacity)!=null?h:1,s=kt(l);s=(s+1)%O.length;let c=O[s].value;a.setSelectedShapeOpacity(c)}else t=(t+1)%O.length,i.overlayOpacity=O[t].value,i.redrawFullCanvas();e()});let n=i.redrawFullCanvas.bind(i);return i.redrawFullCanvas=()=>{n(),e()},i.buttons.push(o),i.uiContainer.appendChild(o),o}var ae='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>',on='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pause"><rect width="4" height="16" x="6" y="4"></rect><rect width="4" height="16" x="14" y="4"></rect></svg>';function re(i,o){let t=document.createElement("button");t.type="button",t.innerHTML=ae,F(t),t.dataset.tooltip="Play/Pause",t.dataset.tooltipPosition="bottom",o.addEvent(i,"play",()=>{t.innerHTML=on}),o.addEvent(i,"pause",()=>{t.innerHTML=ae}),o.addEvent(t,"click",()=>{o.withRefVideo(e=>{e.paused&&e.play().then(()=>{o.showButton("compare")})}),i.paused?i.play().then(()=>{o.redrawFullCanvas()}):(i.pause(),o.raf(()=>{o.redrawFullCanvas()}))}),o.buttons.push(t),o.playerControlsContainer.appendChild(t)}function se(i){return`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-superscript">
        <style>
            .small {
                font-family: auto;
...
`):Number(i)}function In(i){var r;let o=[],t=i.split(`
`),e=null,n=null,a=0;for(let h=0;h<t.length;h++){let l=t[h].trim();if(l===""||l.startsWith("#")||l==="GTOa (4)")continue;let s=l.match(/^(\S+)\s*:\s*(\S+)\s*\((\d+)\)\s*$/);if(s&&a===0){e={name:s[1],protocol:s[2],version:parseInt(s[3]),components:new Map},o.push(e);continue}if(l==="{"){a++;continue}if(l==="}"){a--,a===1&&(n=null),a===0&&(e=null);continue}if(e&&a>=1){if(a===1){let u=l.match(/^"([^"]+)"$/);if(u){n=u[1],e.components.has(n)||e.components.set(n,new Map);continue}if(!l.includes("=")&&!l.includes("[")){n=l,e.components.has(n)||e.components.set(n,new Map);continue}}let c=l.match(/^(\w+)(?:\[([^\]]*)\])?\s+(\w+)\s*=\s*(.+)$/);if(c&&n){let[,u,,p,m]=c,f=Mn(m,u);(r=e.components.get(n))==null||r.set(p,f)}}}return o}function ze(i,o,t){return{x:(i+1)/2,y:(1-o*t)/2}}function Pn(i,o,t){let e=i.get("points"),n=i.get("color"),a=i.get("width");if(!e||e.length<4)return null;let r=o/t,h=[];for(let u=0;u<e.length;u+=2){let p=ze(e[u],e[u+1],r);h.push(p)}let l=n?wt(n):"#000000",s=n&&n.length>=4?n[3]:1,c=2;if(typeof a=="number")c=a*t;else if(Array.isArray(a)&&a.length>0){let u=a[0];typeof u=="number"&&(c=u*t)}return c=Math.max(1,Math.min(c,50)),{type:"curve",points:h,strokeStyle:l,fillStyle:l,lineWidth:c,opacity:s}}function Fn(i,o,t){let e=i.get("position"),n=i.get("color"),a=i.get("text"),r=i.get("size");if(!e||e.length<2||!a)return null;let h=o/t,l=ze(e[0],e[1],h),s=n?wt(n):"#000000",c=n&&n.length>=4?n[3]:1,p=(r!=null?r:.01)*t,m=Math.max(1,(p-16)/.5);return{type:"text",x:l.x,y:l.y,text:a,strokeStyle:s,fillStyle:s,lineWidth:m,opacity:c}}function Ht(i,o={}){var u,p,m,f,y,x,v;let t={frames:[]},e=In(i),n=e.find(g=>g.protocol==="RVSession");if(n){let g=n.components.get("session");if(g){let b=g.get("name");typeof b=="string"&&(t.sessionName=b)}}let a=e.find(g=>g.protocol==="RVFileSource");if(a){let g=a.components.get("media");if(g){let w=g.get("movie");typeof w=="string"&&(t.mediaPath=w)}let b=a.components.get("proxy");if(b){let w=b.get("size");w&&w.length>=2&&(t.dimensions={width:w[0],height:w[1]})}if(!t.dimensions){let w=a.components.get("request");if(w){let M=w.get("width"),S=w.get("height");typeof M=="number"&&typeof S=="number"&&(t.dimensions={width:M,height:S})}}}if(!t.dimensions){let g=e.find(b=>b.protocol==="RVStack");if(g){let b=g.components.get("output");if(b){let w=b.get("size");w&&w.length>=2&&(t.dimensions={width:w[0],height:w[1]})}}}if(!t.dimensions){let g=e.find(b=>b.protocol==="RVSequence");if(g){let b=g.components.get("output");if(b){let w=b.get("size");w&&w.length>=2&&(t.dimensions={width:w[0],height:w[1]})}}}let r=(m=(p=(u=t.dimensions)==null?void 0:u.width)!=null?p:o.width)!=null?m:1920,h=(x=(y=(f=t.dimensions)==null?void 0:f.height)!=null?y:o.height)!=null?x:1080,l=(v=o.fps)!=null?v:25;t.fps=l;let s=e.filter(g=>g.protocol==="RVPaint");if(s.length===0)return t;let c=new Map;for(let g of s)for(let[b,w]of g.components){let M=b.match(/^pen:\d+:(\d+):/i);if(M){let C=parseInt(M[1]),I=Pn(w,r,h);I&&(c.has(C)||c.set(C,[]),c.get(C).push(I));continue}let S=b.match(/^text:\d+:(\d+):/i);if(S){let C=parseInt(S[1]),I=Fn(w,r,h);I&&(c.has(C)||c.set(C,[]),c.get(C).push(I))}}for(let[g,b]of c)t.frames.push({frame:g,fps:l,version:1,shapes:b});return t.frames.sort((g,b)=>g.frame-b.frame),t}function Ve(t){return P(this,arguments,function*(i,o={}){let e=yield i.text();return Ht(e,o)})}B.prototype.initUI=xe;B.prototype.initCanvas=be;B.prototype.addFrameSquareOverlay=Le;B.prototype.addVideoOverlay=He;B.prototype.addProgressBarOverlay=$e;export{B as SmAnnotate,W as defaultConfig,Oe as downloadAsOpenRV,Lt as exportToOpenRV,Rt as hexToRGBA,Ht as parseOpenRV,Ve as parseOpenRVFile,wt as rgbaToHex};
