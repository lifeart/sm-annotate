var fe=Object.create;var ct=Object.defineProperty,ge=Object.defineProperties,ye=Object.getOwnPropertyDescriptor,xe=Object.getOwnPropertyDescriptors,be=Object.getOwnPropertyNames,Ct=Object.getOwnPropertySymbols,we=Object.getPrototypeOf,Et=Object.prototype.hasOwnProperty,Te=Object.prototype.propertyIsEnumerable;var R=Math.pow,kt=(a,o,t)=>o in a?ct(a,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[o]=t,w=(a,o)=>{for(var t in o||(o={}))Et.call(o,t)&&kt(a,t,o[t]);if(Ct)for(var t of Ct(o))Te.call(o,t)&&kt(a,t,o[t]);return a},S=(a,o)=>ge(a,xe(o));var Se=(a,o)=>()=>(o||a((o={exports:{}}).exports,o),o.exports);var Ce=(a,o,t,e)=>{if(o&&typeof o=="object"||typeof o=="function")for(let i of be(o))!Et.call(a,i)&&i!==t&&ct(a,i,{get:()=>o[i],enumerable:!(e=ye(o,i))||e.enumerable});return a};var ke=(a,o,t)=>(t=a!=null?fe(we(a)):{},Ce(o||!a||!a.__esModule?ct(t,"default",{value:a,enumerable:!0}):t,a));var F=(a,o,t)=>new Promise((e,i)=>{var n=l=>{try{h(t.next(l))}catch(s){i(s)}},r=l=>{try{h(t.throw(l))}catch(s){i(s)}},h=l=>l.done?e(l.value):Promise.resolve(l.value).then(n,r);h((t=t.apply(a,o)).next())});var ae=Se((Wn,oe)=>{"use strict";function ze(a){for(var o=1/0,t=-1/0,e=0,i=a.length,n;e<i;e++)n=a[e],o>n&&(o=n),t<n&&(t=n);return{min:o,max:t}}function ee(a,o){var t=Math.pow(2,o-1),e=a<0?a*t:a*(t-1);return Math.max(-t,Math.min(t-1,e))}function ie(a,o,t){var e,i=a.length,n=Math.ceil(i/o),r,h,l,s,c,m,p=ne(t,n*2);for(e=0;e<n;e++)r=e*o,h=(e+1)*o>i?i:(e+1)*o,l=a.subarray(r,h),m=ze(l),c=ee(m.min,t),s=ee(m.max,t),p[e*2]=c,p[e*2+1]=s;return p}function ne(a,o){return new(new Function(`return Int${a}Array`)())(o)}function $e(a,o){var t=a.length,e=1/t,i=a[0].length/2,n=0,r=0,h,l,s=ne(o,i*2);for(r=0;r<i;r++){for(h=0,l=0,n=0;n<t;n++)h+=e*a[n][r*2],l+=e*a[n][r*2+1];s[r*2]=h,s[r*2+1]=l}return[s]}function rt(a,o){return typeof a=="number"?a:o}oe.exports=function(a,o,t,e,i,n){if(o=rt(o,1e3),n=rt(n,16),t==null&&(t=!0),[8,16,32].indexOf(n)<0)throw new Error("Invalid number of bits specified for peaks.");var r=a.numberOfChannels,h=[],l,s,c,m;if(e=rt(e,0),i=rt(i,a.length),typeof a.subarray=="undefined")for(l=0;l<r;l++)c=a.getChannelData(l),m=c.subarray(e,i),h.push(ie(m,o,n));else h.push(ie(a.subarray(e,i),o,n));return t&&h.length>1&&(h=$e(h,n)),s=h[0].length/2,{length:s,data:h,bits:n}}});var Ee={bgPrimary:"rgba(28, 28, 32, 0.95)",bgSecondary:"rgba(42, 42, 48, 0.98)",bgTertiary:"#35353d",bgHover:"rgba(255, 255, 255, 0.08)",bgActive:"rgba(255, 255, 255, 0.12)",textPrimary:"#f0f0f2",textSecondary:"#a8a8b0",textMuted:"#68687a",border:"rgba(255, 255, 255, 0.1)",borderHover:"rgba(255, 255, 255, 0.2)",accent:"#5b9fff",accentHover:"#7db3ff",shadow:"rgba(0, 0, 0, 0.4)"},Ie={bgPrimary:"rgba(250, 250, 252, 0.95)",bgSecondary:"rgba(255, 255, 255, 0.98)",bgTertiary:"#f0f0f5",bgHover:"rgba(0, 0, 0, 0.04)",bgActive:"rgba(0, 0, 0, 0.08)",textPrimary:"#1a1a24",textSecondary:"#5a5a6e",textMuted:"#9090a0",border:"rgba(0, 0, 0, 0.1)",borderHover:"rgba(0, 0, 0, 0.2)",accent:"#2563eb",accentHover:"#3b82f6",shadow:"rgba(0, 0, 0, 0.15)"},Me={dark:Ee,light:Ie},d="sm-annotate";function Pe(a){return`
  ...
  `}function P(a){a.classList.add(`${d}-btn`)}function It(a){a.classList.add(`${d}-container`)}function Mt(a){a.classList.add(`${d}-player-controls`)}function Pt(a){a.classList.add(`${d}-color-picker`)}function Ft(a){a.classList.add(`${d}-slider`)}function Ht(a){a.classList.add(`${d}-fullscreen-btn`)}function Y(){let a=document.createElement("div");return a.classList.add(`${d}-divider`),a}function Dt(a){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Toggle theme",P(o);let t=()=>{let e=a.theme==="dark";o.innerHTML=e?`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    ${t}
  </svg>`}function mt(a){let o=$.findIndex(t=>t.value===a);return o===-1?4:o}function $t(a){let o=document.createElement("button");o.type="button",o.dataset.tooltip="Opacity";let t=mt(a.overlayOpacity),e=()=>{var h;let n=a.currentTool==="move"?a.pluginForTool("move"):null,r=n==null?void 0:n.getSelectedShape();if(r){let l=(h=r.opacity)!=null?h:1,s=mt(l);o.innerHTML=zt($[s],!0),o.dataset.tooltip="Shape opacity"}else o.innerHTML=zt($[t],!1),o.dataset.tooltip="Overlay opacity"};e(),P(o),a.addEvent(o,"click",()=>{var h;let n=a.currentTool==="move"?a.pluginForTool("move"):null,r=n==null?void 0:n.getSelectedShape();if(r&&n){let l=(h=r.opacity)!=null?h:1,s=mt(l);s=(s+1)%$.length;let c=$[s].value;n.setSelectedShapeOpacity(c)}else t=(t+1)%$.length,a.overlayOpacity=$[t].value,a.redrawFullCanvas();e()});let i=a.redrawFullCanvas.bind(a);return a.redrawFullCanvas=()=>{i(),e()},a.buttons.push(o),a.uiContainer.appendChild(o),o}var Vt='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>',He='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pause"><rect width="4" height="16" x="6" y="4"></rect><rect width="4" height="16" x="14" y="4"></rect></svg>';function Ot(a,o){let t=document.createElement("button");t.type="button",t.innerHTML=Vt,P(t),t.dataset.tooltip="Play/Pause",t.dataset.tooltipPosition="bottom",o.addEvent(a,"play",()=>{t.innerHTML=He}),o.addEvent(a,"pause",()=>{t.innerHTML=Vt}),o.addEvent(t,"click",()=>{o.withRefVideo(e=>{e.paused&&e.play().then(()=>{o.showButton("compare")})}),a.paused?a.play().then(()=>{o.redrawFullCanvas()}):(a.pause(),o.raf(()=>{o.redrawFullCanvas()}))}),o.buttons.push(t),o.playerControlsContainer.appendChild(t)}function Wt(a){return`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-superscript">
        <style>
            .small {
                font-family: auto;
